//СТАРАЯ ВЕРСИЯ. НОВАЯ СОВМЕЩЕНА С HLTM
#include <amxmodx>
#include <hl>
#include <fakemeta>   
#include <amxmisc>
...
public vipmodel_handler(id, menu, item){                     
   ...
   switch(pos){  
      case 0:fhl_set_user_model(id, a_Skins[12]) 
      case 1:fhl_set_user_model(id, a_Skins[0]) 
      case 2:fhl_set_user_model(id, a_Skins[1]) 
      case 3:fhl_set_user_model(id, a_Skins[2]) 
      case 4:fhl_set_user_model(id, a_Skins[3]) 
      case 5:fhl_set_user_model(id, a_Skins[4]) 
      case 6:fhl_set_user_model(id, a_Skins[5]) 
      case 7:fhl_set_user_model(id, a_Skins[6]) 
      case 8:fhl_set_user_model(id, a_Skins[7])
      case 9:fhl_set_user_model(id, a_Skins[8])
      case 10:fhl_set_user_model(id,a_Skins[9])
   }                       
   return PLUGIN_HANDLED
}  
